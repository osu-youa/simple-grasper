...
if __name__ == '__main__':
    ...
    # ID_3 = Dynamixel_servo(PH, PROTOCOL_VERSION, 3, debug)           # spread motor
    ...
    # Set goal positions
    if position:
        ID_1.Move(pos_array[0])                             # Yellow
        ID_2.Move(pos_array[1])                             # Blue
        # ID_3.Move(10)                                     # Spread
        ID_4.Move(pos_array[3])                             # Orange
        ...
        while 1:
            ...
            # if actual position of each servo is less than 10 (finger) or 50 (spread), stop moving
            if status1 or status2 or status4:    # or status3
                break

    else:           # specify the torque limit and speed of finger motion
        print(" ")
    ...
    print("")
    print("Motors should now be disabled")
